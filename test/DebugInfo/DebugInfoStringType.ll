...
; CHECK-SPIRV: String [[#StringId:]] "CHARACTER_1_OFFLOAD"
; CHECK-SPIRV: TypeInt [[#TypeIntId:]] 32 0
; CHECK-SPIRV: Constant [[#TypeIntId]] [[#ConstantId:]] 256
; CHECK-SPIRV: [[#TypeStringId:]] [[#]] DebugTypeBasic [[#StringId]] [[#ConstantId]] 8
; CHECK-SPIRV: DebugTypeArray [[#TypeStringId]] [[#]] [[#]]

; CHECK-LLVM: !DIStringType(name: "CHARACTER_1_OFFLOAD", size: 256) 

; ModuleID = 'DebugInfoStringType.bc'
...
!11 = !{!"structtype"}
!12 = !{!""}
!13 = !DILocalVariable(name: "LocalVar1", scope: !14, file: !3, line: 15, type: !18)
...
!20 = !DIStringType(name: "CHARACTER_1_OFFLOAD", size: 256)
!21 = !{!22}
