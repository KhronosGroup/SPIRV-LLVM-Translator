...
; RUN: llvm-spirv %t.bc -spirv-text --spirv-allow-extra-diexpressions --spirv-debug-info-version=nonsemantic-kernel-100
; RUN: llvm-spirv %t.bc -o %t.spv --spirv-allow-extra-diexpressions --spirv-debug-info-version=nonsemantic-kernel-100
