...
// RUN: %clang_cc1 %s -cl-std=clc++ -emit-llvm-bc -triple spir -debug-info-kind=line-tables-only -O0 -o - | llvm-spirv --spirv-debug-info-version=nonsemantic-shader-100 -o %t.spv
