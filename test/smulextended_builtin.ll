...
define spir_func void @test_builtin_smulextcc(i8 %a, i8 %b) {
  entry:
  %0 = alloca %i8struct
  call void @_Z20__spirv_SMulExtendedcc(%i8struct* sret (%i8struct) %0, i8 %a, i8 %b)
  ret void
}
...
define spir_func void @test_builtin_smulextss(i16 %a, i16 %b) {
  entry:
  %0 = alloca %i16struct
  call void @_Z20__spirv_SMulExtendedss(%i16struct* sret (%i16struct) %0, i16 %a, i16 %b)
  ret void
}
...
define spir_func void @test_builtin_smulextii(i32 %a, i32 %b) {
  entry:
  %0 = alloca %i32struct
  call void @_Z20__spirv_SMulExtendedii(%i32struct* sret (%i32struct) %0, i32 %a, i32 %b)
  ret void
}
...
define spir_func void @test_builtin_smulextll(i64 %a, i64 %b) {
  entry:
  %0 = alloca %i64struct
  call void @_Z20__spirv_SMulExtendedll(%i64struct* sret (%i64struct) %0, i64 %a, i64 %b)
  ret void
}
...
define spir_func void @test_builtin_smulextDv4_xS_(<4 x i32> %a, <4 x i32> %b) {
  entry:
  %0 = alloca %vecstruct
  call void @_Z20__spirv_SMulExtendedDv4_iS_(%vecstruct* sret (%vecstruct) %0, <4 x i32> %a, <4 x i32> %b)
  ret void
}
...
declare void @_Z20__spirv_SMulExtendedcc(%i8struct* sret(%i8struct), i8, i8)
declare void @_Z20__spirv_SMulExtendedss(%i16struct* sret(%i16struct), i16, i16)
declare void @_Z20__spirv_SMulExtendedii(%i32struct* sret(%i32struct), i32, i32)
declare void @_Z20__spirv_SMulExtendedll(%i64struct* sret(%i64struct), i64, i64)
declare void @_Z20__spirv_SMulExtendedDv4_iS_(%vecstruct* sret (%vecstruct), <4 x i32>, <4 x i32>)
