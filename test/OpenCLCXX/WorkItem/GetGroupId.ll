...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 26
  %7 = call spir_func i32 @_ZN2cl7__spirv12get_group_idEj(i32 %6)
...
; CHECK-NOT: _ZN2cl7__spirv12get_group_idEj
declare spir_func i32 @_ZN2cl7__spirv12get_group_idEj(i32) #1
