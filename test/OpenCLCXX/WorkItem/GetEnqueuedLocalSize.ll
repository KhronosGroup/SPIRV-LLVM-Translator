...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 32
; CHECK-NOT: _ZN2cl7__spirv23get_enqueued_local_sizeEj
  %7 = call spir_func i32 @_ZN2cl7__spirv23get_enqueued_local_sizeEj(i32 %6)
...
declare spir_func i32 @_ZN2cl7__spirv23get_enqueued_local_sizeEj(i32) #1
