...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 24
  %7 = call spir_func i32 @_ZN2cl7__spirv14get_num_groupsEj(i32 %6)
...
; CHECK-NOT: _ZN2cl7__spirv14get_num_groupsEj
declare spir_func i32 @_ZN2cl7__spirv14get_num_groupsEj(i32) #1
