...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 33
; CHECK-NOT: _ZN2cl7__spirv17get_global_offsetEj
  %7 = call spir_func i32 @_ZN2cl7__spirv17get_global_offsetEj(i32 %6) #0
...
declare spir_func i32 @_ZN2cl7__spirv17get_global_offsetEj(i32) #1
