...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 28
  %7 = call spir_func i32 @_ZN2cl7__spirv13get_global_idEj(i32 %6)
...
; CHECK-NOT: _ZN2cl7__spirv13get_global_idEj
declare spir_func i32 @_ZN2cl7__spirv13get_global_idEj(i32) #1
