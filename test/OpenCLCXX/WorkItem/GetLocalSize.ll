...
; CHECK-DAG: Decorate {{[0-9]+}} BuiltIn 25
  %7 = call spir_func i32 @_ZN2cl7__spirv14get_local_sizeEj(i32 %6)
...
; CHECK-NOT: _ZN2cl7__spirv14get_local_sizeEj
declare spir_func i32 @_ZN2cl7__spirv14get_local_sizeEj(i32) #1
