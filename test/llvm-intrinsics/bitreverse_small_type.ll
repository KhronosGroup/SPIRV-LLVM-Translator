...
; The vector cases cannot be generated by clang++ since elements smaller than a char
; are not supported in vectors.  The vector cases are lowered for completeness.
