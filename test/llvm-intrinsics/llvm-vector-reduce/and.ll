...
; CHECK-SPIRV: LogicalAnd [[#BOOLTYPE]] [[#AND_0_V4XI1TYPE:]] [[#EXTRACT_0_V4XI1TYPE]] [[#EXTRACT_1_V4XI1TYPE]]
; CHECK-SPIRV: LogicalAnd [[#BOOLTYPE]] [[#AND_1_V4XI1TYPE:]] [[#EXTRACT_2_V4XI1TYPE]] [[#EXTRACT_3_V4XI1TYPE]]

; CHECK-SPIRV: LogicalAnd [[#BOOLTYPE]] [[#AND_2_V4XI1TYPE:]] [[#AND_0_V4XI1TYPE]] [[#AND_1_V4XI1TYPE]]
; CHECK-SPIRV: ReturnValue [[#AND_2_V4XI1TYPE]]

; CHECK-LLVM-LABEL: define spir_func i1 @test_vector_reduce_and_v4i1(
...
; CHECK-LLVM: %[[#R0:]] = and i1 %[[#E0]], %[[#E1]]
; CHECK-LLVM: %[[#R1:]] = and i1 %[[#E2]], %[[#E3]]
; CHECK-LLVM: %res = and i1 %[[#R0]], %[[#R1]]
...
define spir_func i1 @test_vector_reduce_and_v4i1(<4 x i1> %v) {
entry:
  %res = call i1 @llvm.vector.reduce.and.v4i1(<4 x i1> %v)
  ret i1 %res
}
