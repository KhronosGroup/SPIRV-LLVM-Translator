...
; CHECK-SPIRV: LogicalNotEqual [[#BOOLTYPE]] [[#ADD_0_V4XI1TYPE:]] [[#EXTRACT_0_V4XI1TYPE]] [[#EXTRACT_1_V4XI1TYPE]]
; CHECK-SPIRV: LogicalNotEqual [[#BOOLTYPE]] [[#ADD_1_V4XI1TYPE:]] [[#EXTRACT_2_V4XI1TYPE]] [[#EXTRACT_3_V4XI1TYPE]]

; CHECK-SPIRV: LogicalNotEqual [[#BOOLTYPE]] [[#ADD_2_V4XI1TYPE:]] [[#ADD_0_V4XI1TYPE]] [[#ADD_1_V4XI1TYPE]]
; CHECK-SPIRV: ReturnValue [[#ADD_2_V4XI1TYPE]]

; CHECK-LLVM-LABEL: define spir_func i1 @test_vector_reduce_add_v4i1(
...
define spir_func i1 @test_vector_reduce_add_v4i1(<4 x i1> %v) {
entry:
  %res = call i1 @llvm.vector.reduce.add.v4i1(<4 x i1> %v)
  ret i1 %res
}
