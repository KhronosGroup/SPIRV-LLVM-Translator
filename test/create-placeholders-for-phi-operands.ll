...
define spir_kernel void @Kernel(i32 addrspace(1)*, i32 addrspace(1)*, i64 %.omp.lb.ascast.val109.zext, i64 %.omp.ub.ascast.val.zext, i64 %.capture_expr.0.ascast.val.zext, i64 %length_.ascast.val.zext) #0 {
BB.0:
