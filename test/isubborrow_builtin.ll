...
; CHECK-LLVM:   store [[i8struct]] %6, ptr %0, align 1
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   store [[i16struct]] %6, ptr %0, align 2
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   store [[i32struct]] %6, ptr %0, align 4
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   store [[i64struct]] %6, ptr %0, align 8
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   store [[vecstruct]] %6, ptr %0, align 16
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:  store [[struct_anon]] %7, ptr addrspace(4) %1, align 4
; CHECK-LLVM:  ret void
