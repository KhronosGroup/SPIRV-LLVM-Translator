...
; CHECK-SPIRV: TaskSequenceGetINTEL [[#TyVoid]] [[#]] [[#PtrCast1]] [[#FPtr3]] [[#ConstantId2]] [[#ConstantId2]]
; CHECK-SPIRV: TaskSequenceReleaseINTEL [[#PtrCast1]]

; CHECK-LLVM: %call.i.i = call spir_func i32 @_Z31__spirv_TaskSequenceCreateINTEL{{.*}}(%task_sequence addrspace(4)* %sot_object.ascast.i, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)* @_Z8user_sotPiS_i, i32 10) #0
; CHECK-LLVM: call spir_func void @_Z30__spirv_TaskSequenceAsyncINTEL{{.*}}(%task_sequence addrspace(4)* %sot_object.ascast.i, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)* @_Z8user_sotPiS_i, i32 %call.i.i, i32 0, i32 addrspace(4)* %arraydecay.i, i32 addrspace(4)* %arraydecay.i, i32 128)
; CHECK-LLVM: call spir_func void @_Z28__spirv_TaskSequenceGetINTEL{{.*}}(%task_sequence addrspace(4)* %sot_object.ascast.i, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)* @_Z8user_sotPiS_i, i32 0, i32 0) #0
...
entry:
  ...
  %call.i.i = call spir_func i32 @_Z31__spirv_TaskSequenceCreateINTELIN2cl4sycl3ext5intel12experimental13task_sequenceIL_Z8user_sotPiS6_iELj10EEEiJS6_S6_iEEjPT_PFT0_DpT1_Ej(%"task_sequence" addrspace(4)* %sot_object.ascast.i, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)* nonnull @_Z8user_sotPiS_i, i32 10) #3
...
for.body.i.i:                                     ; preds = %for.cond.i.i
  call spir_func void @_Z28__spirv_TaskSequenceGetINTELIN2cl4sycl3ext5intel12experimental13task_sequenceIL_Z8user_sotPiS6_iELj10EEEiJS6_S6_iEET0_PT_PFS8_DpT1_Ejj(%"task_sequence" addrspace(4)* %sot_object.ascast.i, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)* nonnull @_Z8user_sotPiS_i, i32 0, i32 0) #3
...
declare dso_local spir_func i32 @_Z31__spirv_TaskSequenceCreateINTELIN2cl4sycl3ext5intel12experimental13task_sequenceIL_Z8user_sotPiS6_iELj10EEEiJS6_S6_iEEjPT_PFT0_DpT1_Ej(%"task_sequence" addrspace(4)*, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)*, i32) local_unnamed_addr #1

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define dso_local spir_func void @_Z8user_sotPiS_i(i32 addrspace(4)* nocapture readonly %data1, i32 addrspace(4)* nocapture readonly %data2, i32 %N) #2 {                            ; preds = %for.cond
  ret void
}

; Function Attrs: convergent nounwind
declare dso_local spir_func void @_Z30__spirv_TaskSequenceAsyncINTELIN2cl4sycl3ext5intel12experimental13task_sequenceIL_Z8user_sotPiS6_iELj10EEEiJS6_S6_iEEvPT_PFT0_DpT1_EjjSC_(%"task_sequence" addrspace(4)*, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)*, i32, i32, i32 addrspace(4)*, i32 addrspace(4)*, i32) local_unnamed_addr #1

; Function Attrs: convergent nounwind
declare dso_local spir_func void @_Z28__spirv_TaskSequenceGetINTELIN2cl4sycl3ext5intel12experimental13task_sequenceIL_Z8user_sotPiS6_iELj10EEEiJS6_S6_iEET0_PT_PFS8_DpT1_Ejj(%"task_sequence" addrspace(4)*, void (i32 addrspace(4)*, i32 addrspace(4)*, i32)*, i32, i32) local_unnamed_addr #1
