...
define dso_local spir_func bfloat @test_AtomicFAddEXT_bfloat(bfloat addrspace(4)* align 2 dereferenceable(4) %Arg) {
entry:
  ...
  %ret = tail call spir_func bfloat @_Z21__spirv_AtomicFAddEXTPU3AS1u6__bf16iiu6__bf16(bfloat addrspace(1)* %0, i32 1, i32 896, bfloat 1.000000e+00)
  ret bfloat %ret
}

; Function Attrs: convergent
declare dso_local spir_func bfloat @_Z21__spirv_AtomicFAddEXTPU3AS1u6__bf16iiu6__bf16(bfloat addrspace(1)*, i32, i32, bfloat)
