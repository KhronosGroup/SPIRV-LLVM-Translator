...
; CHECK-LLVM: %[[FP:.*]] = inttoptr i32 %{{.*}} to ptr
; CHECK-LLVM: %call = call spir_func i32 %[[FP]](i32 %{{.*}})

; CHECK-LLVM-LLC: %[[FP:.*]] = inttoptr i32 %{{.*}} to ptr
; CHECK-LLVM-LLC: call spir_func i32 %[[FP]](i32 %{{.*}})
