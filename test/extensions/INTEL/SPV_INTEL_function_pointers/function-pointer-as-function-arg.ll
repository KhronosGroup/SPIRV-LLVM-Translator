...
; CHECK-SPIRV-UNTYPED: TypeInt [[#TYPE_INT32_ID:]] 32
; CHECK-SPIRV-UNTYPED: TypeFunction [[#FOO_TYPE_ID:]] [[#TYPE_INT32_ID]] [[#TYPE_INT32_ID]]
; CHECK-SPIRV-UNTYPED: TypeUntypedPointerKHR [[#FOO_PTR_TYPE_ID:]] 7
; CHECK-SPIRV-UNTYPED: TypeFunction [[#HELPER_TYPE_ID:]] [[#TYPE_INT32_ID]] [[#FOO_PTR_TYPE_ID]] [[#TYPE_INT32_ID]]
...
; CHECK-SPIRV-UNTYPED: Function {{[0-9]+}} [[#HELPER_ID:]] {{[0-9]+}} [[#HELPER_TYPE_ID]]
; CHECK-SPIRV-UNTYPED: FunctionParameter [[#FOO_PTR_TYPE_ID]] [[#T_PTR_ARG_ID:]]
; CHECK-SPIRV-UNTYPED: UntypedVariableKHR [[#FOO_PTR_TYPE_ID]] [[#T_PTR_ALLOCA_ID:]] 7 [[#FOO_PTR_TYPE_ID]]
; CHECK-SPIRV-UNTYPED: Store [[#T_PTR_ALLOCA_ID]] [[#T_PTR_ARG_ID]]
; CHECK-SPIRV-UNTYPED: Load [[#FOO_PTR_TYPE_ID]] [[#LOADED_T_PTR:]] [[#T_PTR_ALLOCA_ID]]
...
; CHECK-SPIRV-UNTYPED: Function {{[0-9]+}} [[#BAR_ID]] {{[0-9]+}} [[#FOO_TYPE_ID]]
...
; CHECK-SPIRV-UNTYPED: Store [[#F_PTR_ALLOCA_ID]] [[#FOO_PTR_ID]]
; CHECK-SPIRV-UNTYPED: Store [[#F_PTR_ALLOCA_ID]] [[#BAR_PTR_ID]]
; CHECK-SPIRV-UNTYPED: Load [[#FOO_PTR_TYPE_ID]] [[#LOADED_F_PTR:]] [[#F_PTR_ALLOCA_ID]]
; CHECK-SPIRV-UNTYPED: FunctionCall {{[0-9]+}} {{[0-9]+}} [[#HELPER_ID]] [[#LOADED_F_PTR]]
;
