...
entry:
  ...
  %ret = tail call spir_func bfloat @_Z21__spirv_AtomicFMaxEXTPU3AS1DF16biiDF16b(bfloat addrspace(1)* %0, i32 1, i32 896, bfloat 1.000000e+00)
  ret bfloat %ret
}

; Function Attrs: convergent
declare dso_local spir_func bfloat @_Z21__spirv_AtomicFMaxEXTPU3AS1DF16biiDF16b(bfloat addrspace(1)*, i32, i32, bfloat)
