...
entry:
  ...
  %call12 = tail call spir_func <16 x i8> @_Z31intel_sub_group_block_read_uc1614ocl_image2d_roDv2_i(%opencl.image2d_wo_t addrspace(1)* %image_in, <2 x i32> %coord) #2
  ...
  %call13 = tail call spir_func <16 x i8> @_Z31intel_sub_group_block_read_uc16PU3AS1Kh(i16 addrspace(1)* %cp) #2
  tail call spir_func void @_Z32intel_sub_group_block_write_uc16PU3AS1hDv16_h(i16 addrspace(1)* %cp, <16 x i8> %call13) #2
  
  %call14 = tail call spir_func <16 x i16> @_Z31intel_sub_group_block_read_us1614ocl_image2d_roDv2_i(%opencl.image2d_wo_t addrspace(1)* %image_in, <2 x i32> %coord) #2
