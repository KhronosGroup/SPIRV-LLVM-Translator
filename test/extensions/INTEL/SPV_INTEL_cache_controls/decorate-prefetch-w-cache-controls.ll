...
; CHECK-LLVM: call spir_func void @_Z20__spirv_ocl_prefetchPU3AS1Kcm{{.*}}(i8 addrspace(4)* %[[CALL1P4]], i64 1)
...
; CHECK-LLVM: call spir_func void @_Z20__spirv_ocl_prefetchPU3AS1Kcm{{.*}}(i8 addrspace(4)* %[[CALL2P4]], i64 1)
...
; CHECK-LLVM: call spir_func void @_Z20__spirv_ocl_prefetchPU3AS1Kcm{{.*}}(i8 addrspace(4)* %[[CALL3P4]], i64 2)
