...
; CHECK-LLVM: call spir_func half @_Z38__spirv_StochasticRoundFToFINTEL_RhalffsPs(float 1.000000e+00, i16 4, i16* null)
...
entry:
  ...
  %1 = call spir_func half @_Z32__spirv_StochasticRoundFToFINTELfsPs(float 1.0, i16 4, i16* null)
  ret void
}

declare dso_local spir_func half @_Z32__spirv_StochasticRoundFToFINTELfs(float, i16)

declare dso_local spir_func half @_Z32__spirv_StochasticRoundFToFINTELfsPs(float, i16, i16*)
