...
; CHECK-LLVM: define spir_kernel void @test_1{{.*}} !ip_interface ![[#NOACCEPTDOWNSTREAMSTALL:]]
; CHECK-LLVM: define spir_kernel void @test_2{{.*}} !ip_interface ![[#ACCEPTDOWNSTREAMSTALL:]]
; CHECK-LLVM: ![[#NOACCEPTDOWNSTREAMSTALL:]] = !{!"csr"}
; CHECK-LLVM: ![[#ACCEPTDOWNSTREAMSTALL:]] = !{!"csr", !"accept_downstream_stall"}
