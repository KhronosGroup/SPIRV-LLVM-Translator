...
; RUN: llvm-spirv %t.bc -o %t.spv --spirv-ext=+SPV_INTEL_subgroup_buffer_prefetch,+SPV_INTEL_cache_controls
...
declare i8 addrspace(1)* @llvm.ptr.annotation.p1i8(i8 addrspace(1)*, i8*, i8*, i32, i8*)
