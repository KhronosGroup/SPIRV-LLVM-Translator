...
; CHECK-LLVM: %[[ScalarA:.*]] = load i32, i32*
; CHECK-LLVM: %[[ScalarB:.*]] = load i32, i32*
; CHECK-LLVM: %[[ScalarC:.*]] = load i32, i32*
; CHECK-LLVM: call spir_func i32 @_Z28__spirv_BitwiseFunctionINTELiiii(i32 %[[ScalarA]], i32 %[[ScalarB]], i32 %[[ScalarC]], i32 24)
; CHECK-LLVM: %[[VecA:.*]] = load <4 x i32>, <4 x i32>*
; CHECK-LLVM: %[[VecB:.*]] = load <4 x i32>, <4 x i32>*
; CHECK-LLVM: %[[VecC:.*]] = load <4 x i32>, <4 x i32>*
