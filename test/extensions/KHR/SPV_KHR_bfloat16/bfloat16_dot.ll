...
; CHECK-LLVM: %dataA = load <2 x bfloat>, <2 x bfloat>* %addrA
; CHECK-LLVM: %dataB = load <2 x bfloat>, <2 x bfloat>* %addrB
...
entry:
  ...
  %dataA = load <2 x bfloat>, <2 x bfloat>* %addrA
  %dataB = load <2 x bfloat>, <2 x bfloat>* %addrB
