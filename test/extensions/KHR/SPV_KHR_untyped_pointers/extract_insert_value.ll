; This is a copy of extract_insert_value.ll test, but here we want to verify
; that conversion of extract/insert value and getelementptr works with the untyped pointers extension enabled.
