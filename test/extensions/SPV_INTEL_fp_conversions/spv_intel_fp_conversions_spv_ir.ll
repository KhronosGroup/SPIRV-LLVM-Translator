...
; CHECK-LLVM: call spir_func half @_Z43__spirv_ClampStochasticRoundFToFINTEL_RhalffsPc(float 1.000000e+00, i16 4, i8* null)
...
entry:
  ...
  %3 = call spir_func half @_Z37__spirv_ClampStochasticRoundFToFINTELfsPc(float 1.0, i16 4, i8* null)
  ret void
}
...
declare dso_local spir_func half @_Z37__spirv_ClampStochasticRoundFToFINTELfsPc(float, i16, i8*)
