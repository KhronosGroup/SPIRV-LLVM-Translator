...
; CHECK-SPIRV-DAG: TypePointer [[#CharPtr:]] {{[0-9]+}} [[#Char]]
; CHECK-SPIRV-DAG: TypePointer [[#IntPtr:]] {{[0-9]+}} [[#Int]]

; CHECK-SPIRV: FunctionParameter {{[0-9]+}} [[#A:]]

; CHECK-SPIRV: SaveMemoryINTEL [[#CharPtr]] [[#SavedMem:]]
; CHECK-SPIRV: VariableLengthArrayINTEL [[#IntPtr]] {{[0-9]+}} [[#A]]
; CHECK-SPIRV: RestoreMemoryINTEL [[#SavedMem]]

; CHECK-SPIRV: SaveMemoryINTEL [[#CharPtr]] [[#SavedMem2:]]
; CHECK-SPIRV: VariableLengthArrayINTEL [[#IntPtr]] {{[0-9]+}} [[#A]]
; CHECK-SPIRV: RestoreMemoryINTEL [[#SavedMem2]]
...
; CHECK-LLVM: %[[#SavedMem3:]] = call i8* @llvm.stacksave()
...
; CHECK-LLVM: call void @llvm.stackrestore(i8* %[[#SavedMem3]])
