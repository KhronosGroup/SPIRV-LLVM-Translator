...
; CHECK-SPIRV: SpecConstant {{[0-9]+}} [[#SPEC_CONST]]

; CHECK-SPIRV-LABEL: FunctionEnd
; CHECK-SPIRV: FunctionCall {{[0-9]+}} [[#SPEC_CONST_VAL:]] [[#SPEC_CONST_GET:]]
; CHECK-SPIRV: SaveMemoryINTEL
; CHECK-SPIRV: VariableLengthArrayINTEL {{[0-9]+}} {{[0-9]+}} [[#SPEC_CONST_VAL]]
; CHECK-SPIRV: RestoreMemoryINTEL

; CHECK-SPIRV: Function {{[0-9]+}} [[#SPEC_CONST_GET]]
