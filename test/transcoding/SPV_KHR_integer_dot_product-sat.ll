...
; CHECK-SPIRV: 7 SDotAccSatKHR [[#I8]]
; CHECK-SPIRV: 7 SDotAccSatKHR [[#I16]]
; CHECK-SPIRV: 7 SDotAccSatKHR [[#I32]]
; CHECK-SPIRV: 7 SDotAccSatKHR [[#I64]]

; CHECK-SPIRV: 7 UDotAccSatKHR [[#I8]]
; CHECK-SPIRV: 7 UDotAccSatKHR [[#I16]]
; CHECK-SPIRV: 7 UDotAccSatKHR [[#I32]]
; CHECK-SPIRV: 7 UDotAccSatKHR [[#I64]]

; CHECK-SPIRV: 7 SUDotAccSatKHR [[#I8]]
; CHECK-SPIRV: 7 SUDotAccSatKHR [[#I16]]
; CHECK-SPIRV: 7 SUDotAccSatKHR [[#I32]]
; CHECK-SPIRV: 7 SUDotAccSatKHR [[#I64]]

; Function Attrs: nounwind
define spir_kernel void @TestSatPacked(i32 %op0, i32 %op1, i8 %acc8, i16 %acc16, i32 %acc32, i64 %acc64) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !7 !kernel_arg_type_qual !8 !kernel_arg_base_type !7 {
  %1 = call spir_func i8 @_Z27__spirv_SDotAccSatKHR_Rchariici(i32 %op0, i32 %op1, i8 %acc8, i32 0) #0
  %2 = call spir_func i16 @_Z28__spirv_SDotAccSatKHR_Rshortiisi(i32 %op0, i32 %op1, i16 %acc16, i32 0) #0
  %3 = call spir_func i32 @_Z26__spirv_SDotAccSatKHR_Rintiiii(i32 %op0, i32 %op1, i32 %acc32, i32 0) #0
  %4 = call spir_func i64 @_Z27__spirv_SDotAccSatKHR_Rlongiili(i32 %op0, i32 %op1, i64 %acc64, i32 0) #0

  %5 = call spir_func i8 @_Z28__spirv_UDotAccSatKHR_Ruchariici(i32 %op0, i32 %op1, i8 %acc8, i32 0) #0
  %6 = call spir_func i16 @_Z29__spirv_UDotAccSatKHR_Rushortiisi(i32 %op0, i32 %op1, i16 %acc16, i32 0) #0
  %7 = call spir_func i32 @_Z27__spirv_UDotAccSatKHR_Ruintiiii(i32 %op0, i32 %op1, i32 %acc32, i32 0) #0
  %8 = call spir_func i64 @_Z28__spirv_UDotAccSatKHR_Rulongiili(i32 %op0, i32 %op1, i64 %acc64, i32 0) #0

  %9 = call spir_func i8 @_Z28__spirv_SUDotAccSatKHR_Rchariici(i32 %op0, i32 %op1, i8 %acc8, i32 0) #0
  %10 = call spir_func i16 @_Z29__spirv_SUDotAccSatKHR_Rshortiisi(i32 %op0, i32 %op1, i16 %acc16, i32 0) #0
  %11 = call spir_func i32 @_Z27__spirv_SUDotAccSatKHR_Rintiiii(i32 %op0, i32 %op1, i32 %acc32, i32 0) #0
  %12 = call spir_func i64 @_Z28__spirv_SUDotAccSatKHR_Rlongiili(i32 %op0, i32 %op1, i64 %acc64, i32 0) #0
  ret void
}
...
; Function Attrs: nounwind
define spir_kernel void @TestSatVec(<4 x i8> %op0, <4 x i8> %op1, i8 %acc8, i16 %acc16, i32 %acc32, i64 %acc64) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !9 !kernel_arg_type_qual !8 !kernel_arg_base_type !9 {
  %1 = call spir_func i8 @_Z27__spirv_SDotAccSatKHR_RcharDv4_cS_c(<4 x i8> %op0, <4 x i8> %op1, i8 %acc8) #0
  %2 = call spir_func i16 @_Z28__spirv_SDotAccSatKHR_RshortDv4_cS_s(<4 x i8> %op0, <4 x i8> %op1, i16 %acc16) #0
  %3 = call spir_func i32 @_Z26__spirv_SDotAccSatKHR_RintDv4_cS_i(<4 x i8> %op0, <4 x i8> %op1, i32 %acc32) #0
  %4 = call spir_func i64 @_Z27__spirv_SDotAccSatKHR_RlongDv4_cS_l(<4 x i8> %op0, <4 x i8> %op1, i64 %acc64) #0

  %5 = call spir_func i8 @_Z28__spirv_UDotAccSatKHR_RucharDv4_cS_c(<4 x i8> %op0, <4 x i8> %op1, i8 %acc8) #0
  %6 = call spir_func i16 @_Z29__spirv_UDotAccSatKHR_RushortDv4_cS_s(<4 x i8> %op0, <4 x i8> %op1, i16 %acc16) #0
  %7 = call spir_func i32 @_Z27__spirv_UDotAccSatKHR_RuintDv4_cS_i(<4 x i8> %op0, <4 x i8> %op1, i32 %acc32) #0
  %8 = call spir_func i64 @_Z28__spirv_UDotAccSatKHR_RulongDv4_cS_l(<4 x i8> %op0, <4 x i8> %op1, i64 %acc64) #0

  %9 = call spir_func i8 @_Z28__spirv_SUDotAccSatKHR_RcharDv4_cS_c(<4 x i8> %op0, <4 x i8> %op1, i8 %acc8) #0
  %10 = call spir_func i16 @_Z29__spirv_SUDotAccSatKHR_RshortDv4_cS_s(<4 x i8> %op0, <4 x i8> %op1, i16 %acc16) #0
  %11 = call spir_func i32 @_Z27__spirv_SUDotAccSatKHR_RintDv4_cS_i(<4 x i8> %op0, <4 x i8> %op1, i32 %acc32) #0
  %12 = call spir_func i64 @_Z28__spirv_SUDotAccSatKHR_RlongDv4_cS_l(<4 x i8> %op0, <4 x i8> %op1, i64 %acc64) #0
  ret void
}
...
; Function Attrs: nounwind
define spir_kernel void @TestSatAll(<2 x i16> %op0, <2 x i16> %op1, i8 %acc8, i16 %acc16, i32 %acc32, i64 %acc64) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !10 !kernel_arg_type_qual !8 !kernel_arg_base_type !10 {
  %1 = call spir_func i16 @_Z28__spirv_SDotAccSatKHR_RshortDv2_sS_s(<2 x i16> %op0, <2 x i16> %op1, i16 %acc16) #0
  %2 = call spir_func i32 @_Z26__spirv_SDotAccSatKHR_RintDv2_sS_i(<2 x i16> %op0, <2 x i16> %op1, i32 %acc32) #0
  %3 = call spir_func i64 @_Z27__spirv_SDotAccSatKHR_RlongDv2_sS_l(<2 x i16> %op0, <2 x i16> %op1, i64 %acc64) #0

  %4 = call spir_func i16 @_Z29__spirv_UDotAccSatKHR_RushortDv2_sS_s(<2 x i16> %op0, <2 x i16> %op1, i16 %acc16) #0
  %5 = call spir_func i32 @_Z27__spirv_UDotAccSatKHR_RuintDv2_sS_i(<2 x i16> %op0, <2 x i16> %op1, i32 %acc32) #0
  %6 = call spir_func i64 @_Z28__spirv_UDotAccSatKHR_RulongDv2_sS_l(<2 x i16> %op0, <2 x i16> %op1, i64 %acc64) #0

  %7 = call spir_func i16 @_Z29__spirv_SUDotAccSatKHR_RshortDv2_sS_s(<2 x i16> %op0, <2 x i16> %op1, i16 %acc16) #0
  %8 = call spir_func i32 @_Z27__spirv_SUDotAccSatKHR_RintDv2_sS_i(<2 x i16> %op0, <2 x i16> %op1, i32 %acc32) #0
  %9 = call spir_func i64 @_Z28__spirv_SUDotAccSatKHR_RlongDv2_sS_l(<2 x i16> %op0, <2 x i16> %op1, i64 %acc64) #0
  ret void
}
