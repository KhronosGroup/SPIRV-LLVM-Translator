...
; CHECK-SPIRV: 6 SDotKHR [[#I8]]
; CHECK-SPIRV: 6 SDotKHR [[#I16]]
; CHECK-SPIRV: 6 SDotKHR [[#I32]]
; CHECK-SPIRV: 6 SDotKHR [[#I64]]

; CHECK-SPIRV: 6 UDotKHR [[#I8]]
; CHECK-SPIRV: 6 UDotKHR [[#I16]]
; CHECK-SPIRV: 6 UDotKHR [[#I32]]
; CHECK-SPIRV: 6 UDotKHR [[#I64]]

; CHECK-SPIRV: 6 SUDotKHR [[#I8]]
; CHECK-SPIRV: 6 SUDotKHR [[#I16]]
; CHECK-SPIRV: 6 SUDotKHR [[#I32]]
; CHECK-SPIRV: 6 SUDotKHR [[#I64]]

; Function Attrs: nounwind
define spir_kernel void @TestNonSatPacked(i32 %op0, i32 %op1) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !7 !kernel_arg_type_qual !8 !kernel_arg_base_type !7 {
  %1 = call spir_func i8 @_Z21__spirv_SDotKHR_Rchariii(i32 %op0, i32 %op1, i32 0) #0
  %2 = call spir_func i16 @_Z22__spirv_SDotKHR_Rshortiii(i32 %op0, i32 %op1, i32 0) #0
  %3 = call spir_func i32 @_Z20__spirv_SDotKHR_Rintiii(i32 %op0, i32 %op1, i32 0) #0
  %4 = call spir_func i64 @_Z21__spirv_SDotKHR_Rlongiii(i32 %op0, i32 %op1, i32 0) #0

  %5 = call spir_func i8 @_Z22__spirv_UDotKHR_Ruchariii(i32 %op0, i32 %op1, i32 0) #0
  %6 = call spir_func i16 @_Z23__spirv_UDotKHR_Rushortiii(i32 %op0, i32 %op1, i32 0) #0
  %7 = call spir_func i32 @_Z21__spirv_UDotKHR_Ruintiii(i32 %op0, i32 %op1, i32 0) #0
  %8 = call spir_func i64 @_Z22__spirv_UDotKHR_Rulongiii(i32 %op0, i32 %op1, i32 0) #0

  %9 = call spir_func i8 @_Z22__spirv_SUDotKHR_Rchariii(i32 %op0, i32 %op1, i32 0) #0
  %10 = call spir_func i16 @_Z23__spirv_SUDotKHR_Rshortiii(i32 %op0, i32 %op1, i32 0) #0
  %11 = call spir_func i32 @_Z21__spirv_SUDotKHR_Rintiii(i32 %op0, i32 %op1, i32 0) #0
  %12 = call spir_func i64 @_Z22__spirv_SUDotKHR_Rlongiii(i32 %op0, i32 %op1, i32 0) #0
  ret void
}
...
; Function Attrs: nounwind
define spir_kernel void @TestNonSatVec(<4 x i8> %op0, <4 x i8> %op1) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !9 !kernel_arg_type_qual !8 !kernel_arg_base_type !9 {
  %1 = call spir_func i8 @_Z21__spirv_SDotKHR_RcharDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %2 = call spir_func i16 @_Z22__spirv_SDotKHR_RshortDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %3 = call spir_func i32 @_Z20__spirv_SDotKHR_RintDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %4 = call spir_func i64 @_Z21__spirv_SDotKHR_RlongDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0

  %5 = call spir_func i8 @_Z22__spirv_UDotKHR_RucharDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %6 = call spir_func i16 @_Z23__spirv_UDotKHR_RushortDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %7 = call spir_func i32 @_Z21__spirv_UDotKHR_RuintDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %8 = call spir_func i64 @_Z22__spirv_UDotKHR_RulongDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0

  %9 = call spir_func i8 @_Z22__spirv_SUDotKHR_RcharDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %10 = call spir_func i16 @_Z23__spirv_SUDotKHR_RshortDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %11 = call spir_func i32 @_Z21__spirv_SUDotKHR_RintDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  %12 = call spir_func i64 @_Z22__spirv_SUDotKHR_RlongDv4_cS_(<4 x i8> %op0, <4 x i8> %op1) #0
  ret void
}
...
; Function Attrs: nounwind
define spir_kernel void @TestNonSatAll(<2 x i16> %op0, <2 x i16> %op1) #0 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !10 !kernel_arg_type_qual !8 !kernel_arg_base_type !10 {
  %1 = call spir_func i16 @_Z22__spirv_SDotKHR_RshortDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %2 = call spir_func i32 @_Z20__spirv_SDotKHR_RintDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %3 = call spir_func i64 @_Z21__spirv_SDotKHR_RlongDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0

  %4 = call spir_func i16 @_Z23__spirv_UDotKHR_RushortDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %5 = call spir_func i32 @_Z21__spirv_UDotKHR_RuintDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %6 = call spir_func i64 @_Z22__spirv_UDotKHR_RulongDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0

  %7 = call spir_func i16 @_Z23__spirv_SUDotKHR_RshortDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %8 = call spir_func i32 @_Z21__spirv_SUDotKHR_RintDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  %9 = call spir_func i64 @_Z22__spirv_SUDotKHR_RlongDv2_sS_(<2 x i16> %op0, <2 x i16> %op1) #0
  ret void
}
