...
; CHECK-LLVM: call spir_func void @_Z10ndrange_1Djjj(%struct.ndrange_t* sret %ndrange, i32 0, i32 123, i32 456)
; CHECK-LLVM-SPV: call spir_func void @_Z23__spirv_BuildNDRange_1Diii(%struct.ndrange_t* sret %ndrange, i32 123, i32 456, i32 0)
