...
; CHECK-SPIRV: TypeFunction [[FOO_TY:[0-9]+]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV: TypeFunction [[DEST_TY:[0-9]+]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV: TypePointer [[DEST_TY_PTR:[0-9]+]] {{[0-9]+}} [[DEST_TY]]
; CHECK-SPIRV: TypePointer [[FOO_TY_PTR:[0-9]+]] {{[0-9]+}} [[FOO_TY]]
; CHECK-SPIRV: ConstFunctionPointerINTEL [[FOO_TY_PTR]] [[FOO_PTR:[0-9]+]] [[FOO:[0-9]+]]
; CHECK-SPIRV: Function {{[0-9]+}} [[FOO]] {{[0-9]+}} [[FOO_TY]]

; CHECK-SPIRV: Bitcast [[DEST_TY_PTR]] {{[0-9]+}} [[FOO_PTR]]
...
define dso_local spir_func signext i8 @foo(i8 signext %x) #0 {
  ret i8 %x
}
