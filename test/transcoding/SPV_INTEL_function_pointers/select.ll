...
; CHECK-SPIRV: TypeFunction [[FUNC_TYPE:[0-9]+]] [[INT32]] [[INT32]]
; CHECK-SPIRV: TypePointer [[FUNC_PTR_TYPE:[0-9]+]] {{[0-9]+}} [[FUNC_TYPE]]
...
; CHECK-SPIRV: Load [[FUNC_PTR_TYPE]] [[LOAD:[0-9]+]] [[FPTR]]
; CHECK-SPIRV: FunctionPointerCallINTEL {{[0-9]+}} {{[0-9]+}} [[LOAD]]
