...
; CHECK-LLVM: call spir_func <4 x half> @_Z11read_imageh11ocl_image2dDv2_i

; CHECK-LLVM-LABEL: @withsamp
; CHECK-LLVM: call spir_func <4 x half> @_Z11read_imageh11ocl_image2d11ocl_samplerDv2_i

; CHECK-LLVM-LABEL: @writehalf
; CHECK-LLVM: call spir_func void @_Z12write_imageh11ocl_image2dDv2_iDv4_Dh
