...
entry:
  %call = call spir_func double @_Z31intel_convert_as_bfloat16_floatt(i32 zeroext 0) #2
  ret void
}

; Function Attrs: convergent
declare spir_func double @_Z31intel_convert_as_bfloat16_floatt(i32 zeroext) #1
