// RUN: %clang_cc1 -triple spir -cl-std=cl2.0  /work/tmp/tmp.cl -include opencl-c-base.h -emit-llvm-bc -o %t.bc
// RUN: llvm-spirv %t.bc -o %t.spv
// RUN: spirv-val %t.spv
// RUN: llvm-spirv %t.spv -to-text -o - | FileCheck %s --check-prefix=CHECK-SPIRV
// RUN: llvm-spirv %t.spv -r -o - | llvm-dis -o - | FileCheck %s --check-prefix=CHECK-LLVM

// The following declaration is copied from opencl-c.h
__attribute__((overloadable))
int atomic_load_explicit(volatile atomic_int *object, memory_order order, memory_scope scope);
