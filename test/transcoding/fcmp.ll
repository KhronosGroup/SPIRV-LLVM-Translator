...
; CHECK-LLVM: %r2 = fcmp nnan oeq float %a, %b
; CHECK-LLVM: %r3 = fcmp ninf oeq float %a, %b
; CHECK-LLVM: %r4 = fcmp nsz oeq float %a, %b
; CHECK-LLVM: %r5 = fcmp arcp oeq float %a, %b
; CHECK-LLVM: %r6 = fcmp fast oeq float %a, %b
; CHECK-LLVM: %r7 = fcmp nnan ninf oeq float %a, %b
; CHECK-LLVM: %r8 = fcmp one float %a, %b
; CHECK-LLVM: %r9 = fcmp nnan one float %a, %b
; CHECK-LLVM: %r10 = fcmp ninf one float %a, %b
; CHECK-LLVM: %r11 = fcmp nsz one float %a, %b
; CHECK-LLVM: %r12 = fcmp arcp one float %a, %b
; CHECK-LLVM: %r13 = fcmp fast one float %a, %b
; CHECK-LLVM: %r14 = fcmp nnan ninf one float %a, %b
; CHECK-LLVM: %r15 = fcmp olt float %a, %b
; CHECK-LLVM: %r16 = fcmp nnan olt float %a, %b
; CHECK-LLVM: %r17 = fcmp ninf olt float %a, %b
; CHECK-LLVM: %r18 = fcmp nsz olt float %a, %b
; CHECK-LLVM: %r19 = fcmp arcp olt float %a, %b
; CHECK-LLVM: %r20 = fcmp fast olt float %a, %b
; CHECK-LLVM: %r21 = fcmp nnan ninf olt float %a, %b
; CHECK-LLVM: %r22 = fcmp ogt float %a, %b
; CHECK-LLVM: %r23 = fcmp nnan ogt float %a, %b
; CHECK-LLVM: %r24 = fcmp ninf ogt float %a, %b
; CHECK-LLVM: %r25 = fcmp nsz ogt float %a, %b
; CHECK-LLVM: %r26 = fcmp arcp ogt float %a, %b
; CHECK-LLVM: %r27 = fcmp fast ogt float %a, %b
; CHECK-LLVM: %r28 = fcmp nnan ninf ogt float %a, %b
; CHECK-LLVM: %r29 = fcmp ole float %a, %b
; CHECK-LLVM: %r30 = fcmp nnan ole float %a, %b
; CHECK-LLVM: %r31 = fcmp ninf ole float %a, %b
; CHECK-LLVM: %r32 = fcmp nsz ole float %a, %b
; CHECK-LLVM: %r33 = fcmp arcp ole float %a, %b
; CHECK-LLVM: %r34 = fcmp fast ole float %a, %b
; CHECK-LLVM: %r35 = fcmp nnan ninf ole float %a, %b
; CHECK-LLVM: %r36 = fcmp oge float %a, %b
; CHECK-LLVM: %r37 = fcmp nnan oge float %a, %b
; CHECK-LLVM: %r38 = fcmp ninf oge float %a, %b
; CHECK-LLVM: %r39 = fcmp nsz oge float %a, %b
; CHECK-LLVM: %r40 = fcmp arcp oge float %a, %b
; CHECK-LLVM: %r41 = fcmp fast oge float %a, %b
; CHECK-LLVM: %r42 = fcmp nnan ninf oge float %a, %b
...
; CHECK-LLVM: %r47 = fcmp nnan ueq float %a, %b
; CHECK-LLVM: %r48 = fcmp ninf ueq float %a, %b
; CHECK-LLVM: %r49 = fcmp nsz ueq float %a, %b
; CHECK-LLVM: %r50 = fcmp arcp ueq float %a, %b
; CHECK-LLVM: %r51 = fcmp fast ueq float %a, %b
; CHECK-LLVM: %r52 = fcmp nnan ninf ueq float %a, %b
; CHECK-LLVM: %r53 = fcmp une float %a, %b
; CHECK-LLVM: %r54 = fcmp nnan une float %a, %b
; CHECK-LLVM: %r55 = fcmp ninf une float %a, %b
; CHECK-LLVM: %r56 = fcmp nsz une float %a, %b
; CHECK-LLVM: %r57 = fcmp arcp une float %a, %b
; CHECK-LLVM: %r58 = fcmp fast une float %a, %b
; CHECK-LLVM: %r59 = fcmp nnan ninf une float %a, %b
; CHECK-LLVM: %r60 = fcmp ult float %a, %b
; CHECK-LLVM: %r61 = fcmp nnan ult float %a, %b
; CHECK-LLVM: %r62 = fcmp ninf ult float %a, %b
; CHECK-LLVM: %r63 = fcmp nsz ult float %a, %b
; CHECK-LLVM: %r64 = fcmp arcp ult float %a, %b
; CHECK-LLVM: %r65 = fcmp fast ult float %a, %b
; CHECK-LLVM: %r66 = fcmp nnan ninf ult float %a, %b
; CHECK-LLVM: %r67 = fcmp ugt float %a, %b
; CHECK-LLVM: %r68 = fcmp nnan ugt float %a, %b
; CHECK-LLVM: %r69 = fcmp ninf ugt float %a, %b
; CHECK-LLVM: %r70 = fcmp nsz ugt float %a, %b
; CHECK-LLVM: %r71 = fcmp arcp ugt float %a, %b
; CHECK-LLVM: %r72 = fcmp fast ugt float %a, %b
; CHECK-LLVM: %r73 = fcmp nnan ninf ugt float %a, %b
; CHECK-LLVM: %r74 = fcmp ule float %a, %b
; CHECK-LLVM: %r75 = fcmp nnan ule float %a, %b
; CHECK-LLVM: %r76 = fcmp ninf ule float %a, %b
; CHECK-LLVM: %r77 = fcmp nsz ule float %a, %b
; CHECK-LLVM: %r78 = fcmp arcp ule float %a, %b
; CHECK-LLVM: %r79 = fcmp fast ule float %a, %b
; CHECK-LLVM: %r80 = fcmp nnan ninf ule float %a, %b
; CHECK-LLVM: %r81 = fcmp uge float %a, %b
; CHECK-LLVM: %r82 = fcmp nnan uge float %a, %b
; CHECK-LLVM: %r83 = fcmp ninf uge float %a, %b
; CHECK-LLVM: %r84 = fcmp nsz uge float %a, %b
; CHECK-LLVM: %r85 = fcmp arcp uge float %a, %b
; CHECK-LLVM: %r86 = fcmp fast uge float %a, %b
; CHECK-LLVM: %r87 = fcmp nnan ninf uge float %a, %b
