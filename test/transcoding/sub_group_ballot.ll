...
; CHECK-LLVM: %[[inverse_ballot:.*]] = call spir_func i32 @_Z24sub_group_inverse_ballotDv4_j(<4 x i32> %[[ballot]])
; CHECK-LLVM-NEXT: icmp ne i32 %[[inverse_ballot]], 0
; CHECK-LLVM: %[[bit_extract:.*]] = call spir_func i32 @_Z28sub_group_ballot_bit_extractDv4_jj(<4 x i32> %[[ballot]], i32 0)
...
; CHECK-SPV-IR: call spir_func <4 x i32> @_Z29__spirv_BuiltInSubgroupEqMaskv()
; CHECK-SPV-IR: call spir_func <4 x i32> @_Z29__spirv_BuiltInSubgroupGeMaskv()
; CHECK-SPV-IR: call spir_func <4 x i32> @_Z29__spirv_BuiltInSubgroupGtMaskv()
; CHECK-SPV-IR: call spir_func <4 x i32> @_Z29__spirv_BuiltInSubgroupLeMaskv()
; CHECK-SPV-IR: call spir_func <4 x i32> @_Z29__spirv_BuiltInSubgroupLtMaskv()
