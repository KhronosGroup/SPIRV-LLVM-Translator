...
entry:
  ...
  ; CHECK-LLVM-CL20: call spir_func float @[[FLOAT_FUNC_NAME:_Z25atomic_fetch_add_explicit[[:alnum:]]+_Atomicff[a-zA-Z0-9_]+]](float addrspace(4)* %a.as, float -2.290000e+02, i32 0, i32 1)
  ; CHECK-LLVM-SPV: call spir_func float @[[FLOAT_FUNC_NAME:_Z21__spirv_AtomicFAddEXT[[:alnum:]]+fiif]](float addrspace(1)* %a, i32 2, i32 0, float -2.290000e+02)
...
entry:
  ...
  ; CHECK-LLVM-CL20: call spir_func double @[[DOUBLE_FUNC_NAME:_Z25atomic_fetch_add_explicit[[:alnum:]]+_Atomicdd[a-zA-Z0-9_]+]](double addrspace(4)* %a.as, double -3.340000e+02, i32 0, i32 1)
  ; CHECK-LLVM-SPV: call spir_func double @[[DOUBLE_FUNC_NAME:_Z21__spirv_AtomicFAddEXT[[:alnum:]]+diid]](double addrspace(1)* %a, i32 2, i32 0, double -3.340000e+02)
