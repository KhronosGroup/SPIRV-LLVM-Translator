...
; CHECK-SPIRV: Decorate [[#REG1]] MathOpDSPModeINTEL 0 1

; CHECK-LLVM: !prefer_dsp ![[#REG2:]]
; CHECK-LLVM-SAME: !propagate_dsp_preference ![[#REG3:]]
...
define internal spir_func void @"_Z25math_prefer_dsp_propagateIZ4mainE3$_0EvT_"(%class.anon* byval(%class.anon) align 1 %f) #1 !prefer_dsp !3 !propagate_dsp_preference !4 {
entry:
