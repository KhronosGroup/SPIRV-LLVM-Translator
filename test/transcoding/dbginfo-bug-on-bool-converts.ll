...
; CHECK: @trunc_to_i1(i32 %iarg) #{{[0-9]+}} !dbg !{{[0-9]+}} {
; CHECK-NEXT: !dbg ![[TRUNC_LINE:[0-9]+]]
; CHECK-NEXT: !dbg ![[TRUNC_LINE]]
; CHECK-NEXT: ret i1 %res, !dbg ![[TRUNC_RET_LINE:[0-9]+]]
...
; CHECK: @sext_from_i1(i1 %barg) #{{[0-9]+}} !dbg !{{[0-9]+}} {
; CHECK-NEXT: !dbg ![[SEXT_LINE:[0-9]+]]
; CHECK: ret i32 %res, !dbg ![[SEXT_RET_LINE:[0-9]+]]
...
; CHECK: @zext_from_i1(i1 %barg) #{{[0-9]+}} !dbg !{{[0-9]+}} {
; CHECK-NEXT: !dbg ![[ZEXT_LINE:[0-9]+]]
; CHECK: ret i32 %res, !dbg ![[ZEXT_RET_LINE:[0-9]+]]
...
; CHECK: @sitofp_b(i1 %barg) #{{[0-9]+}} !dbg !{{[0-9]+}} {
; CHECK-NEXT: !dbg ![[SITOFP_LINE:[0-9]+]]
; CHECK-NEXT: !dbg ![[SITOFP_LINE]]
; CHECK: ret float %res, !dbg ![[SITOFP_RET_LINE:[0-9]+]]
...
; CHECK: @uitofp_b(i1 %barg) #{{[0-9]+}} !dbg !{{[0-9]+}} {
; CHECK-NEXT: !dbg ![[UITOFP_LINE:[0-9]+]]
; CHECK-NEXT: !dbg ![[UITOFP_LINE]]
; CHECK: ret float %res, !dbg ![[UITOFP_RET_LINE:[0-9]+]]
