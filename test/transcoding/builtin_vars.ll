...
; CHECK-SPV-IR: @__spirv_BuiltInGlobalLinearId = external addrspace(1) global i32
...
entry:
  ...
  ; CHECK-SPV-IR: %0 = addrspacecast i32 addrspace(1)* @__spirv_BuiltInGlobalLinearId to i32 addrspace(4)*
  ; CHECK-SPV-IR: %1 = load i32, i32 addrspace(4)* %0, align 4
  ret void
}
