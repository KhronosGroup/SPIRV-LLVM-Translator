...
define dso_local spir_func i32 @wrappedload(i32 addrspace(4)* %a) local_unnamed_addr #2 {
entry:
  %0 = load i32, i32 addrspace(4)* %a, align 4
  ret i32 %0
}

; Function Attrs: norecurse nounwind readnone
define dso_local spir_func void @wrappedstore(i32 %a, i32 addrspace(4)* %b) local_unnamed_addr #2 {
entry:
  store i32 %a, i32 addrspace(4)* %b, align 4
  ret void
}
