...
; CHECK-LLVM:   call spir_func void @_Z20__spirv_UMulExtendedhh(%i8struct* sret([[i8struct]]) %0, i8 %a, i8 %b)
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   call spir_func void @_Z20__spirv_UMulExtendedtt(%i16struct* sret([[i16struct]]) %0, i16 %a, i16 %b)
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   call spir_func void @_Z20__spirv_UMulExtendedjj(%i32struct* sret([[i32struct]]) %0, i32 %a, i32 %b)
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   call spir_func void @_Z20__spirv_UMulExtendedmm(%i64struct* sret([[i64struct]]) %0, i64 %a, i64 %b)
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:   call spir_func void @_Z20__spirv_UMulExtendedDv4_jS_(%vecstruct* sret([[vecstruct]]) %0, <4 x i32> %a, <4 x i32> %b)
; CHECK-LLVM:   ret void
...
; CHECK-LLVM:  call spir_func void @_Z20__spirv_UMulExtendedjj.1(%struct.anon addrspace(4)* sret([[struct_anon]]) %1, i32 %a, i32 %b)
; CHECK-LLVM:  ret void
